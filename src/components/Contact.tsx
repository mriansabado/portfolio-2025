          ...
          >
            <div className="bg-gray-800/50 p-6 rounded-lg backdrop-blur-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-300">
                  ...
                  <span>mriansabado@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-300">
                  <svg
                    className="w-5 h-5"
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg backdrop-blur-sm">
              ...
              <div className="flex space-x-4">
                ...
                <a
                href="https://leetcode.com/YOUR_USERNAME" // Replace with your LeetCode username
                target="_blank"
          ...
          >
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-md bg-gray-800/50 border border-gray-600 text-white px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            <div>
