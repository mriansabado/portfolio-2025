      ...
      <section className="relative overflow-hidden bg-black w-screen" style={{
        ...
        <div className="relative flex items-center justify-center z-10">
          <p className="medium-description text-center px-4 md:px-16">
            <span className="normal-description">I'm a Software Developer who specializes in </span> 
            AI integration 
            <span className="normal-description"> and building AI-powered applications. I keep up with the latest tools and have shipped AI features that automate workflows and reduce manual effort.</span>
          </p>
        </div>
      </section> 
