  ...
  return (
    ...
    <nav>
      <div className="nav__content">
        <img
          src="https://assets.codepen.io/605876/bear-2022--black.png"
          alt=""
        />
        <a
          href="https://twitter.com/intent/follow?screen_name=jh3yy"x
          target="_blank"
          >Follow</a
        >
      </div>
    ...
    <main>
      <section>
        ...
        <div className="bleed-canvas">
          <img className="chopsticks" src="https://assets.codepen.io/605876/chopsticks.png" alt="" />
          <img className="bento" src="https://assets.codepen.io/605876/bento-box.png" alt="" />
          <img className="veribear" src="https://assets.codepen.io/605876/Veribear.svg" alt="" />
        </div>
      </section>
      <section>
        <p>
